     ...
     0.1786f, 0.4286f, 0.6429f, 0.7143f, 0.5357f}; 
        ...
        while(1){ 
          ...
          fpga_tools::UnrolledLoop<DoF_smooth>([&Out_add, &index_out_2](auto idx_3){
              PipeOutMMul_2::template PipeAt<idx_3>::write(Out_add[index_out_2++]);
          }); 
    ...
    void operator()() const
      {
        ...
        while(1){
          ...
          fpga_tools::UnrolledLoop<DoF_smooth>([&Out, &index_3](auto idx_4){
              ...
              PipeOut::template PipeAt<idx_4>::write(Out[index_3++]);
          });
        }
    }
};
...
struct ARSmooth{
  void operator()() const{
    ...
    while(1){
      ...
      float add_DoF_MMUL = adder_out_DoF + adder_out_MMUL;
